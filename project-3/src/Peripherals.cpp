...
//
    ...
    /*
i8 sample_stick_u_x() {
    return analogRead(STICK_U_PIN_X);
    ...
    */
    ...
    /*
i8 sample_stick_u_y() {
    return analogRead(STICK_U_PIN_Y);
...
//
    ...
    /*
i8 sample_stick_m_x() {
    return analogRead(STICK_M_PIN_X);
    static float rolling_x = 0;
    ...
    */
    ...
    /*
i8 sample_stick_m_y() {
    return analogRead(STICK_M_PIN_Y);
    static float rolling_y = 0;
